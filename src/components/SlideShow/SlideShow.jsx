  ...
  return (
    <div className="w-full flex flex-col mt-5 mb-10">
      ...
      <div className="flex flex-row justify-center gap-10 mr-10 ml-10">
        <button
          onClick={handlePrev}
          className=" hover:-translate-x-1 hover:scale-110 duration-300 hidden xl:flex xl:items-center"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
        ...
        <div className="flex justify-center flex-row gap-1 sm:gap-2 md:gap-3 lg:gap-4 xl:gap-5 2xl:gap-6 w-1/2 h-1/2 ">
          {visiblePictures.map((p) => (
            <div className="w-72" key={p.id}>
              ...
              <div className="w-full">
                ...
                src={p.imgSrc}
                alt={`Image ${p.id}`}
                className=" h-96 object-cover rounded-xl  hover:contrast-75 hover:opacity-75"
              />
              </div>
